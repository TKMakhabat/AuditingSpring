...
public class Auditing {
    ...
    @Before("execution(* com.makhabatusen.auditing.TransferService.transfer(..))")
    ...
    @AfterReturning("execution(* com.makhabatusen.auditing.TransferService.transfer(..))")
    public void success(){
        System.out.println("bank successfully transferred amount");
    }
    //After failed transfer service
    @AfterThrowing("execution(* com.makhabatusen.auditing.TransferService.transfer(..))")
